...
export const reverseScriptMap: ReverseScriptMapping = {
  "CER-10234": {
    "TS-324472": "ts-1",
    "TS-324473": "ts-2", 
    "TS-324474": "ts-3",
...
export const STATUS_BADGE_VARIANTS: StatusBadgeVariants = {
  "Approved": "default bg-green-100 text-green-800 border-green-200",
  "COQ Responded": "default bg-blue-100 text-blue-800 border-blue-200",
  "Action Item Responded": "default bg-blue-100 text-blue-800 border-blue-200",
  "Action Item Issued": "default bg-amber-100 text-amber-800 border-amber-200",
  "COQ Requested": "default bg-gray-100 text-gray-800 border-gray-200",
};

export const mockTestScripts: TestScript[] = [
  {
    id: "1",
